...
void write_display1()
{
  glColor3f(0.0,0.0,0.0);
    ...
    write_function(-0.15f, 0.25f, 0.0f, GLUT_BITMAP_HELVETICA_18,"-> Press [_] For Level : 1");
    write_function(-0.15f, 0.2f, 0.0f, GLUT_BITMAP_HELVETICA_18, "-> Score 5 in level 1 For Level : 2");
    write_function(-0.15f, 0.15f, 0.0f, GLUT_BITMAP_HELVETICA_18,"-> Score 5 in level 2 For Level : 3");
...
total_score = total_score + score;
    ...
    // Switch to level 3 if total score is 10
    if (total_score == 10)
    {
        game_fun(3);
        score = 0;
...
void write_score()
{
        ...
        write_function(0,.65,0,GLUT_BITMAP_HELVETICA_18,text);
...
fruitBasket();
    ...
    cloud3();
    bird();
    write_function(0,.7,0,GLUT_BITMAP_HELVETICA_18,"level 1");
    write_score();
    ground();
    drawGrass();
    riverbank ();
...
fruitBasket();
    ...
    bird();
    write_score();
    write_function(0,.7,0,GLUT_BITMAP_HELVETICA_18,"level 2");
    ground();
    drawGrass();
    riverbank ();
    river ();
...
fruitBasket();
    ...
    cloud3();
    bird();
    write_function(0,.7,0,GLUT_BITMAP_HELVETICA_18,"level 3");
    write_score();
    ground();
    drawGrass();
    riverbank ();
...
void game_fun(int level)
{
    ...
    // Update total score and switch to level 2 if score is 5
